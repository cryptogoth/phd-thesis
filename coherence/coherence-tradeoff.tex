...
\begin{theorem}{\texbf{Instantaneous coherence and pebble game space.}}
...
Then the layer coherence $\tilde{Q}$ is upper-bounded by
the sum of all the instantaneous pebble game spaces, and the total
coherence $Q$ is upper-bounded by the total pebble game space
\end{theorem}
