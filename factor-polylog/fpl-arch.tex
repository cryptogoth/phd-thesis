...
A single, contiguous
2D lattice that contains an entire quantum architecture which may be prohibitively large to manufacture. In practice,
...
An graphic depiction of three modules in \textsf{2D CCNTCM} is shown in
