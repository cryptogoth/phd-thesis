...
Our technique hinges on several key building blocks, including
constant-depth communication from Section \ref{sec:intro-cdc}
and hybrid architectures with modules from Section \ref{sec:intro-modules}.
