% Paul Pham's Dissertation
% To Become an Amazing DOCTOR OF PHILOSOPHY
...
%
\Title{Low-depth quantum architectures for factoring}
\Author{Paul Pham}
\Year{2013}
...
% ----- dedication
%
\dedication{\begin{center}To my family, teachers, friends, and muses.\\
...
% ========== Chapter 1
\input{factor-polylog/factor-polylog.tex} 


% ========== Chapter 2
\input{factor-sublog/factor-sublog.tex} 

% ========== Chapter 3

\input{qcompile/qcompile.tex} 
 
% ========== Chapter 4

\input{coherence/coherence.tex}
