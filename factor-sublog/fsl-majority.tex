...
We are also interested in majority gates of polynomial fanin.
...
\begin{theorem}{\textbf{(Yeh-Varvarigos) Multiple product in constant depth
...
\begin{theorem}{\textbf{(Yeh-Varvarigos) Modular reduction in constant depth
and polynomial size \cite{Yeh1996}.}}
